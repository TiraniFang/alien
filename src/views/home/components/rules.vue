    ...
    <div class="rule">
      ...
      <div class="content flex space-around">
        ...
        <div>
          ...
          <p>
            1：生存快速匹配单排模式前十名<br />2：生存快速匹配双排模式前六名<br />3：生存快速匹配三排模式前三名<br />
            <!-- 4：生存天人之战单排模式前十名<br />5：生存天人之战双排模式前六名<br />6：生存天人之战三排模式前三名<br /> -->
            4：生存天选单人模式前十名<br />5：生存天选双人模式前六名<br />
            6：生存天选三人模式前六名<br />7：娱乐无尽试炼模式前五名<br />8：娱乐武道争锋模式前四名
            <!-- <br />8：娱乐地脉之战模式前六名 -->
            <br />9：娱乐暗域狂潮模式前三名
            <!-- <br />10：娱乐无尽枪火模式前六名 -->
            <!-- <br /> -->
